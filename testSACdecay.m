%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Script to test the effect of limited data length on SAC (cf. Figure 6 of
% Kessler et al.). Four different data lengths are tested.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% 1. Set parameters for spike train generation 
DT = 0.002;        % alt.: 0.01; [ms] time step
